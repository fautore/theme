...
apply_current :: proc() -> bool {
	...
	reload_apps()
	fmt.printf(
		"Applied %s. Restart existing Neovim, Firefox, and Chrome instances to update them. SDDM changes appear on the next login screen.\n",
		theme.display_name,
	)
	return kde_ok && sddm_ok && browsers_ok
}
